...
@Component({
  ...
  templateUrl: "./employment-order-edit.component.html",
  styleUrls: ["./employment-order-edit.component.scss"],
  providers: [EmploymentOrderService],
})
export class EmploymentOrderEditComponent implements OnInit {
